...
/** Parses audit endpoint responses into rows the audit workspace can render. */
...
/** Converts one possible audit payload shape into a normalized table row. */
...
/** Formats the local audit poll timestamp for the workspace metadata panel. */
function formatSyncTime(date: Date): string {
  return date.toISOString().replace("T", " ").replace(/\.\d{3}Z$/, " UTC");
}

/** Renders audit trail rows after client-side carrier endpoint polling. */
